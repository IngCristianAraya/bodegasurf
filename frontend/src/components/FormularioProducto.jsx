...
const FormularioProducto = ({ producto, onChange, onSubmit, onScanClick, hideHeader = false, onFileChange }) => {
  ...
  useEffect(() => {
    if (producto && producto.images && producto.images.length > 0) {
      setImagenPreview(producto.images[0].url);
    } else if (producto && typeof producto.imagen === 'string' && producto.imagen) {
  ...
  const validarCampos = () => {
    ...
    setErrores({ ...nuevosErrores, imagen: errores.imagen });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <input
                ...
                onChange={onChange}
                className={`w-full p-2 border ${errores.nombre ? 'border-red-500' : 'border-gray-300'
                  } rounded-lg`}
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={onChange}
                    className={`w-full pr-10 p-2 border ${errores.categoria ? 'border-red-500' : 'border-gray-300'
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={onChange}
                    className={`w-full pr-10 p-2 border ${errores.unidad ? 'border-red-500' : 'border-gray-300'
                      } rounded-lg appearance-none bg-white`}
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    className={`pl-10 w-full p-2 border ${errores.precioCompra ? 'border-red-500' : 'border-gray-300'
                      } rounded-lg`}
                    placeholder="0.00"
                    min="0"
                    step="0.01"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    className={`pl-10 w-full p-2 border ${errores.precioVenta ? 'border-red-500' : 'border-gray-300'
                      } rounded-lg`}
                    placeholder="0.00"
                    min="0"
                    step="0.01"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    className={`pl-10 w-full p-2 border ${errores.stock ? 'border-red-500' : 'border-gray-300'
                      } rounded-lg`}
                    placeholder="0"
                    min="0"
                    step="1"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    className={`pl-10 w-full p-2 border ${errores.stockMinimo ? 'border-red-500' : 'border-gray-300'
                      } rounded-lg`}
                    placeholder="0"
                    min="0"
                    step="1"
